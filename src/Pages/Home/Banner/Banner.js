  ...
  return (
    <>
      ...
      >
        <SwiperSlide>
          <div
            className="lg:h-[600px] h-[240px] bg-cover bg-center bg-no-repeat text-white relative"
            style={{
          ...
          >
            <div className="bg-gradient-to-r from-black to-transparent h-full w-full lg:pt-32 p-5 lg:pl-20">
              ...
              <p className="py-3 text-sm lg:block hidden max-w-3xl">
        ...
        <SwiperSlide>
          ...
          >
            <div className="bg-gradient-to-r from-black to-transparent h-full w-full lg:pt-32 p-5 lg:pl-20">
              ...
              <p className="py-3 text-sm max-w-3xl lg:block hidden">
        ...
        <SwiperSlide>
          <div
            className="lg:h-[600px] h-[240px] bg-cover bg-center bg-no-repeat text-white lg:relative"
            style={{
